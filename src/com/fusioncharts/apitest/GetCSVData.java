...
public class GetCSVData extends APITestBase {
	
	//The api name according to the data sheet
	private final static String apiName = "getCSVData()"; 
	Object[][] data;
	...
	@Test(priority = 1)
	public void verifyAPIExistsInDataSheetGetCSVData()
	{
	...
	@Test(priority = 2)
	public void verifyChartIsRenderedGetCSVData()
	{
	...
	@Test(priority = 3)
	public void verifyAPIGetCSVData() throws IOException
	{
        ...
        test.log(LogStatus.PASS, test.addScreenCapture(APITestBase.capture("GetCSVData_CSV data should show above chart")));	//Code Line for screenshot
	}
	...
	public void shutDown() 
	{
		try
		{
			System.out.println("getCSVData() executed");
			Thread.sleep(3000);
		}
