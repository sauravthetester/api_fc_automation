...
public class SetChartData extends APITestBase 
{
	...
	public void verifyAPISetChartData() throws IOException
	{
		...
		test.log(LogStatus.PASS, test.addScreenCapture(APITestBase.capture("SetChartData()_Column 2D chart showing with Data1")));
		...
		test.log(LogStatus.PASS, test.addScreenCapture(APITestBase.capture("SetChartData()_Column 2D chart showing with Data2, should be different from Data1")));
	}
