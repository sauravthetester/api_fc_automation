...
public class IsPlotItemSliced_slicePlotItem extends APITestBase {
	...
	@Test(priority = 1)
	public void verifyAPIExistsInDataSheetPlotItemSliced() 
	{
	...
	@Test(priority = 2)
	public void verifyChartIsRenderedPlotItemSliced()
	{
	...
	@Test(priority = 3)
	public void verifyAPIPlotItemSliced() throws IOException
	{
		Object boolValue;
